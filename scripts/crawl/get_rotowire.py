...
def get_home_away(team_stats, home, away):
    ...
    # print("home_name: {}".format(home_name))
    # print("away_name: {}".format(away_name))
    # print("home_city: {}".format(home_city))
    # print("away_city: {}".format(away_city))
    # print("home_id: {}".format(home_id))
    # print("away_id: {}".format(away_id))
