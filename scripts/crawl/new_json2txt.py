...
parser.add_argument('--input', type=str, default='outputs/rotowire_json/', help='path to train/valid/test.json files')
parser.add_argument('--output', type=str, default='outputs/rotowire_txt/', help='path to txt format files')
